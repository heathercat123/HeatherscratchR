<?php
	...
	$comment_id = ($comment_type) ? $comment['Gcomment']['id']:$comment['id'];
	$comment_content = ($comment_type) ? $comment['Gcomment']['content']:$comment['content'];
	$timestamp = ($comment_type) ? $comment['Gcomment']['timestamp']:$comment['timestamp'];
	?>	
	<h5>
