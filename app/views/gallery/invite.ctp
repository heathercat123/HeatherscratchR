...
<div id="main">
<div class="container">
  <h3><?php ___('Invite friends to join'); ?> <?php e($theme_name)?></h3>
...
//	$session->flash(FLASH_ERROR_KEY);
	...
	<p><?php ___('Invite friends on Scratch'); ?>:
	...
	<td>
	<div class="sidecontainer">
	<h4><?php ___('Invitation list'); ?></h4>
	<div style="width:215px;">
	  <form action="/galleries/invite?gid=<?php e($theme_id)?>" method="post">
		<ul id="invitelist" class="sidelist"></ul>
	    <p><input type="submit" class="button" value=<?php ___('Invite'); ?>></p>
	  </form>
	</div>
	</div>
	</td>
