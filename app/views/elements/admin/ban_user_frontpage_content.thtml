...
<div class="fullcontent">
	...
	<?php endif; ?>
	<form id="admin_banuser" action="<?=e("/administration/add_banned_user_frontpage")?>" method="post">
		<p>Username: <br/><input type="text" id="admin_banuser_name" name="admin_banuser_name" value="<?php e($default_name); ?>" size="40" /></p>
		...
		<?php 
			...
			'class'=>'button', 'url' => "/administration/add_banned_user_frontpage", 
...
<div class="fullcontent">
	...
	<h5> Frontpage Banned Users </h5>
	</div>
	<div id="admin_banlist_results">
		<div id='ajax_pagination'>
			<?php
				echo $this->renderElement('admin/banned_user_frontpage_list', Array('data' => $data));
			?>
		</div>
	</div>
</div>