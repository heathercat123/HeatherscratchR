<?php 
	...
	?>
		<div class="comment">
				...
				<p align="right">
				<?php
				echo "(" . $ajax->link("Delete", '#', array("url"=>"/administration" . "/" . "deletecomment" . "/" . $project_id . "/" . $comment_id . "/" . "fcomments", "update"=>"admin_project_comments", "condition"=>1), NULL, false) . ")";
				?>
				</p>
		</div>
