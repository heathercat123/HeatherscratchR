...
<h3><?php ___('Upload project'); ?></h3>
    ...
    <?php
				...
				echo "</div>";
?>
<form id="create_gallery" action="<?php echo $html->url('/projects/share_project/')?>" method="post" enctype='multipart/form-data'>
...
<div class = "project_share_form">
	<div class = "project_share_item_left">
		<label for="create_gallery_name"><?php ___('Priview image'); ?></label>
	</div>
	<div class = "project_share_item_right">
...
<div class = "gallery_create_form">
	...
	<div class = "project_share_item_checkbox">
		<?php echo $form->checkbox('Project.sound',array('checked'=>'checked'))?>
		<strong><?php ___('Compress sounds and images'); ?></strong>
	</div>
</div>
