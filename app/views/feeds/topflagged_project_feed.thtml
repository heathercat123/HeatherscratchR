...
<rss version="2.0">
  <channel> 
    <title>Latest Unreviewed Projects</title> 
    <link><?php echo $rss_link; ?></link> 
    <description>Last 15 unreviewed projects</description> 
    ...
    <item> 
      ...
      <description><?php echo htmlentities($html->image($project['Project']['image_link'],array('title'=>$project['Project']['name'],'alt'=>$project['Project']['name'],'width'=>'148','height'=>'111','border'=>1)));?><?php echo htmlspecialchars($project['Project']['description']); ?></description> 
